...
public final class LocalDeployment {
	...
	public static final MachineDescriptor MACHINE_1_DESCRIPTOR = new MachineDescriptor( MACHINE_1_UID, MACHINE_1_ADDRESS, MACHINE_1_DATA_PORT, MACHINE_1_MSG_PORT );
	...
	public static final MachineDescriptor MACHINE_2_DESCRIPTOR = new MachineDescriptor( MACHINE_2_UID, MACHINE_2_ADDRESS, MACHINE_2_DATA_PORT, MACHINE_2_MSG_PORT );
	...
	public static final MachineDescriptor MACHINE_3_DESCRIPTOR = new MachineDescriptor( MACHINE_3_UID, MACHINE_3_ADDRESS, MACHINE_3_DATA_PORT, MACHINE_3_MSG_PORT );
	...
	public static final MachineDescriptor MACHINE_4_DESCRIPTOR = new MachineDescriptor( MACHINE_4_UID, MACHINE_4_ADDRESS, MACHINE_4_DATA_PORT, MACHINE_4_MSG_PORT );
	...
	public static final TaskDescriptor TASK_1_DESCRIPTOR = new TaskDescriptor( MACHINE_1_DESCRIPTOR, TASK_1_UID, TASK_1_NAME ); 
	...
	public static final TaskDescriptor TASK_2_DESCRIPTOR = new TaskDescriptor( MACHINE_2_DESCRIPTOR, TASK_2_UID, TASK_2_NAME ); 
	...
	public static final TaskDescriptor TASK_3_DESCRIPTOR = new TaskDescriptor( MACHINE_3_DESCRIPTOR, TASK_3_UID, TASK_3_NAME );
	...
	public static final TaskDescriptor TASK_4_DESCRIPTOR = new TaskDescriptor( MACHINE_4_DESCRIPTOR, TASK_4_UID, TASK_4_NAME );
	...
	public static final TaskDescriptor TASK_5_DESCRIPTOR = new TaskDescriptor( MACHINE_2_DESCRIPTOR, TASK_5_UID, TASK_5_NAME );
	...
	public static final TaskDescriptor TASK_6_DESCRIPTOR = new TaskDescriptor( MACHINE_4_DESCRIPTOR, TASK_6_UID, TASK_6_NAME );
	...
	public static final TaskBindingDescriptor TASK_1_BINDING = new TaskBindingDescriptor( TASK_1_DESCRIPTOR, Arrays.asList( TASK_1_INPUT ), Arrays.asList( TASK_1_OUTPUT ) );
	...
	public static final TaskBindingDescriptor TASK_2_BINDING = new TaskBindingDescriptor( TASK_2_DESCRIPTOR, Arrays.asList( TASK_2_INPUT ), Arrays.asList( TASK_2_OUTPUT ) );
	...
	public static final TaskBindingDescriptor TASK_3_BINDING = new TaskBindingDescriptor( TASK_3_DESCRIPTOR, Arrays.asList( TASK_3_INPUT ), Arrays.asList( TASK_3_OUTPUT ) );
	...
	public static final TaskBindingDescriptor TASK_4_BINDING = new TaskBindingDescriptor( TASK_4_DESCRIPTOR, Arrays.asList( TASK_4_INPUT ), Arrays.asList( TASK_4_OUTPUT ) );
	...
	public static final TaskBindingDescriptor TASK_5_BINDING = new TaskBindingDescriptor( TASK_5_DESCRIPTOR, Arrays.asList( TASK_5_INPUT ), Arrays.asList( TASK_5_OUTPUT ) );
