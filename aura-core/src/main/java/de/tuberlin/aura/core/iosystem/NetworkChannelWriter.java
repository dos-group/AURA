...
public class NetworkChannelWriter extends AbstractWriter {

    public NetworkChannelWriter(final UUID srcTaskID, final UUID dstTaskID, IEventDispatcher dispatcher, InetSocketAddress remoteAddress, EventLoopGroup eventLoopGroup) {
        this(srcTaskID, dstTaskID, dispatcher, remoteAddress, eventLoopGroup, DEFAULT_BUFFER_SIZE);
    }

    public NetworkChannelWriter(final UUID srcTaskID, final UUID dstTaskID, IEventDispatcher dispatcher, InetSocketAddress remoteAddress, EventLoopGroup eventLoopGroup, int bufferSize) {
