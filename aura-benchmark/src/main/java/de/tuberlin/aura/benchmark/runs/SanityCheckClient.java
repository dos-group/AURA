...
public final class SanityCheckClient {
     ...
     * Logger.
     */
    private static final org.slf4j.Logger LOG = LoggerFactory.getLogger(SanityCheckClient.class);

    // Disallow Instantiation.
    private SanityCheckClient() {}
    ...
    public static class Source extends AbstractInvokeable {
        ...
        public Source(final ITaskDriver taskDriver, IDataProducer producer, final IDataConsumer consumer, final Logger LOG) {
