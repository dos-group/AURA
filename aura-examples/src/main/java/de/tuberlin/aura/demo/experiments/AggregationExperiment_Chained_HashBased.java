...
public class AggregationExperiment_Chained_HashBased {
    ...
    private static Topology.OperatorNode createSourceFold1Node(final int dop) {
    ...
    private static Topology.OperatorNode createFold2SinkNode(final int dop) {
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            atb1.addNode(createSourceFold1Node(dop)).
                    connectTo("Sort2", Topology.Edge.TransferType.ALL_TO_ALL).
                    addNode(createFold2SinkNode(dop));
            ...
            atb2.addNode(createSourceFold1Node(dop)).
                    connectTo("Sort2", Topology.Edge.TransferType.ALL_TO_ALL).
                    addNode(createFold2SinkNode(dop));
            ...
            atb3.addNode(createSourceFold1Node(dop)).
                    connectTo("Sort2", Topology.Edge.TransferType.ALL_TO_ALL).
                    addNode(createFold2SinkNode(dop));
            ...
            atb4.addNode(createSourceFold1Node(dop)).
                    connectTo("Sort2", Topology.Edge.TransferType.ALL_TO_ALL).
                    addNode(createFold2SinkNode(dop));
            ...
            atb5.addNode(createSourceFold1Node(dop)).
                    connectTo("Sort2", Topology.Edge.TransferType.ALL_TO_ALL).
                    addNode(createFold2SinkNode(dop));
            ...
            atb6.addNode(createSourceFold1Node(dop)).
                    connectTo("Sort2", Topology.Edge.TransferType.ALL_TO_ALL).
                    addNode(createFold2SinkNode(dop));
            ...
            atb7.addNode(createSourceFold1Node(dop)).
                    connectTo("Sort2", Topology.Edge.TransferType.ALL_TO_ALL).
                    addNode(createFold2SinkNode(dop));
